								...
								<div class="profile-tabnav">
									...
									<ul class="nav nav-tabs">
										...
										<li class="nav-item">
											...
											<a class="nav-link active" data-toggle="tab" href="#courses"><i class="ti-book"></i> Mes Cours</a>
										...
										<li class="nav-item">
											...
											<a class="nav-link" data-toggle="tab" href="#change-password"><i class="ti-lock"></i>Changer Mots de Passe </a>

										</li>

										<li class="nav-item">

											<a class="nav-link" data-toggle="tab" href="{{ route('logout') }}" onclick="event.preventDefault();

											document.getElementById('logout-form').submit();"><i class="ti-bookmark-alt"></i> Me Deconnecter </a>
