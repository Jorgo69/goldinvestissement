...
<!-- Header Top ==== -->
    ...
    <!-- Content -->
      ...
      <div class="page-content bg-white">
        ...
        <div class="page-banner ovbl-dark" style="background-image:url({{asset('https://images.pexels.com/photos/15203364/pexels-photo-15203364.jpeg?auto=compress&cs=tinysrgb&w=600')}});">

            <div class="container">

                <div class="page-banner-entry">

                    <h1 class="text-white">Formation Détails</h1>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							...
							<div class="course-detail-bx">
								...
								<div class="course-buy-now text-center">
									...
									<a href="#" class="btn radius-xl text-uppercase">Achetez ce cours</a>
						...
						<div class="col-lg-9 col-md-8 col-sm-12">
							...
							<div class="courses-post">
								...
								<div class="ttr-post-media media-effect">
									...
									<a href="#"><img src="{{asset('/storage/public/images/url_images/'. $courses-> url_image)}}" alt=""></a>
								...
								<div class="row">
									...
									<div class="col-md-12 col-lg-4">
										...
										<ul class="course-features">
											...
											<li><i class="ti-time"></i> <span class="label">Duration</span> <span class="value"> {{$courses -> duree_cours }}</span></li>

											<li><i class="ti-stats-up"></i> <span class="label">Skill level</span> <span class="value"> {{$courses -> difficulte_cours }}</span></li>

											<li><i class="ti-smallcap"></i> <span class="label">Language</span> <span class="value"> {{$courses -> langue_cours }}</span></li>
									...
									<div class="col-md-12 col-lg-8">
										...
										<h5 class="m-b5">Résultats d'apprentissage</h5>
											...
											<ul>
												...
												<li>
													...
													<div class="curriculum-list-box">
														...
														<span>Lesson </span> {{$courses -> plan_un }}
										...
										<li>
											...
											<ul>
												...
												<li>
													...
													<span>Lesson </span> {{$courses -> plan_trois }}
