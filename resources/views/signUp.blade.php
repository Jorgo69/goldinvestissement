		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					...
					<p> Connexion avec <a href="{{ route ('connexion') }}"> votre compte </a></p>
				</div>	
				<form method="POST" action="{{ route('register') }}">
					...
					<div class="row mb-3">
						...
						<div class="col-md-6">
							<select class="form-select form-select-lg mb-3 @error('pays') is-invalid @enderror" value="{{ old('pays') }}"  name="pays" aria-label="Default select example">
					...
					<div class="row mb-3">
						...
						<div class="col-md-6">
							<select type="select" class="form-select @error('sexe') is-invalid @enderror" value="{{ old('sexe') }}" aria-label="Default select example">
