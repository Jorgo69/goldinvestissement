...
<head>
	...
	<link rel="icon" href="{{asset('assets/images/perso/logoJak.png') }}" type="image/x-icon" />

	<link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/images/event/logo.jpg') }}" />
				...
				<div class="container">
					...
					<div class="d-flex align-items-stretch">
						...
						<div class="pt-logo mr-auto">
							...
							<a href="#"><img src="{{asset('assets/images/perso/logojakS.png') }}" width="50" alt=""/></a>
